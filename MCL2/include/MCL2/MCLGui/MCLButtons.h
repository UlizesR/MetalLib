/*
    File:   MCLButtons.h
    About:
        The header file for the MCLButtons class.
...
/*!
    * @brief Set the action callback and target of a button.
    * @param button The button to set the action callback of.
    * @param action The action callback of the button.
    * @param target The target of the button.
*/
void MCL_SetButtonActionTarget(MCL_Button *button, MCL_ActionCallback action, void *target);

/*!
    Just like MCL_AddButton, but does not add the button to a View.
...
/*!
    * @brief Create a new button
    * @param View The View to add the button to
    * @param button The button to create
...
/*!
    ...
    * @param View The View to add the checkbox to
...
/*!
    ...
    * @param View The View to add the radio button to
...
/*!
    * @brief Removes a button from the View.
