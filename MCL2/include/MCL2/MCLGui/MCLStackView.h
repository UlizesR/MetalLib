...
#include "MCL2/MCLCore/MCLView.h"
#include "MCL2/MCLCore/MCLCore.h"
#include "MCL2/MCLGui/MCLButtons.h"
...
/*!
    ...
    * @param View The View to add the stack to.
...
/*!
    ...
    * @param stack The stack to add the View to.
    * @param View The View to add to the stack.
*/
void MCL_Stack_Add_View(MCL_Stack *stack, MCL_View *view, uint32_t gravity);
