...
static NSTableView* getNSTableViewFromMacView(M_View* tableView) {
    return (__bridge NSTableView *)(tableView->_this);
}
...
void M_CreateTable(M_View* tableView, M_TableColumn* columns, int columnCount) {
    ...
    float columnWidth = (float)tableView->size.width / columnCount;
    ...
    [nsTableView setHeaderView:[[NSTableHeaderView alloc] initWithFrame:NSMakeRect(0, 0, tableView->size.width, 18)]];
